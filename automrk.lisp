...
(defun mark-assignments (submissions-dir is-zipped grades-export-dir test-cases-dir &optional (weights nil))
          ...
          (let ((type (pathname-type pathname)))
            ...
            (progn
              ...
              (let* ((std-name (get-student-name (namestring pathname)))
                     ...
                     (std-solution-list (mark-std-solution pathname test-cases-dir weights))
